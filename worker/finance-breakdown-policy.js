...
export const FINANCE_EXPENSE_RESET_IMPORT_KEY = "finance-expenses-2026-08-12-reset-v1";
...
export const FINANCE_BREAKDOWN_SEED = Object.freeze([
  Object.freeze({ id: "breakdown-2026-08-expense-home-services", replacesId: "sheet-2026-08-expense-home", occurredOn: "2026-08-28", month: 8, type: "expense", category: "home", subcategory: "Services", amount: 280_000, status: "planned", note: "Detailed plan migrated from Finance Tracker" }),
  Object.freeze({ id: "breakdown-2026-08-expense-home-household-shopping", replacesId: "sheet-2026-08-expense-home", occurredOn: "2026-08-28", month: 8, type: "expense", category: "home", subcategory: "Household shopping", amount: 300_000, status: "planned", note: "Detailed plan migrated from Finance Tracker" }),
  Object.freeze({ id: "breakdown-2026-08-expense-haircare-haircut", replacesId: "sheet-2026-08-expense-haircare", occurredOn: "2026-08-28", month: 8, type: "expense", category: "haircare", subcategory: "Haircut", amount: 150_000, status: "planned", note: "Detailed plan migrated from Finance Tracker" }),
  Object.freeze({ id: "breakdown-2026-10-expense-home-rent", replacesId: "sheet-2026-10-expense-home", occurredOn: "2026-10-28", month: 10, type: "expense", category: "home", subcategory: "Rent", amount: 3_900_000, status: "planned", note: "Detailed plan migrated from Finance Tracker" }),
]);
