...
import {
  handleSaleDealDeleteRequest,
  isSaleDealDeleteRoute,
} from "./sale-deal-delete.js";
import {
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (isSaleDealDeleteRoute(pathname, request)) {
        return handleSaleDealDeleteRequest(request, env);
      }
