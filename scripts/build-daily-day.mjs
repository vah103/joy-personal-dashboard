...
builtScript = builtScript.replace(
  '<div class="dd-summary"><div class="dd-stat"><span>${esc(t("dailyDay.done"))}</span><strong data-dd-done>${summary.complete} ${esc(t("dailyDay.items"))}</strong></div><div class="dd-stat"><span>${esc(t("dailyDay.remaining"))}</span><strong data-dd-remaining>${summary.remaining} ${esc(t("dailyDay.items"))}</strong></div><div class="dd-stat"><span>${esc(t("dailyDay.templateUsing"))}</span><strong>${esc(t(templateKey(templateId)))}</strong></div></div>',
  '<div class="dd-summary"><div class="dd-stat"><i class="dd-stat-icon">✓</i><span>${esc(t("dailyDay.done"))}</span><strong data-dd-done>${summary.complete} ${esc(t("dailyDay.items"))}</strong></div><div class="dd-stat"><i class="dd-stat-icon">◷</i><span>${esc(t("dailyDay.remaining"))}</span><strong data-dd-remaining>${summary.remaining} ${esc(t("dailyDay.items"))}</strong></div><div class="dd-stat"><i class="dd-stat-icon">▤</i><span>${esc(t("dailyDay.templateUsing"))}</span><strong>${esc(t(templateKey(templateId)))}</strong></div></div>',
);
...
if (!builtScript.includes("dd-block-title") || !builtScript.includes("dd-stat-icon") || !builtScript.includes("No snacks") || !builtScript.includes("data-dd-block-progress") || !builtScript.includes("refreshCheckProgress")) {
