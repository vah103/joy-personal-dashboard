...
const projectHubHead = [
  ...
  '    <link rel="stylesheet" href="turtlebot-card-art.css?v=restored-card-v2">\n',
  '    <link rel="stylesheet" href="project-data/turtlebot4/turtlebot-card-robot-layer.css?v=robot-layer-v1">\n',
].join("");
