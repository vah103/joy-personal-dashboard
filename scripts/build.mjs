...
const projectHubHead = [
  ...
  '    <link rel="stylesheet" href="project-data/ielts/ielts-writing-review.css?v=ielts-writing-review-v1">\n',
  '    <link rel="stylesheet" href="project-data/ielts/ielts-writing-rewrite.css?v=ielts-writing-rewrite-v1">\n',
...
const projectHubScripts = [
  ...
  '    <script id="joy-ielts-core-bundle" src="project-data/ielts/ielts-core-bundle.js?v=ielts-august-core-v8" defer></script>\n',
