...
const copies = [
  ...
  [resolve(salesFeatures, "manager", "manager.js"), "sale-manager.js"],
  [resolve(salesFeatures, "manager", "manager.css"), "sale-manager.css"],
  [resolve(salesFeatures, "room-summary", "legacy-room-summary.js"), "room-summary.js"],
  [resolve(salesFeatures, "room-summary", "room-summary.css"), "room-summary.css"],
