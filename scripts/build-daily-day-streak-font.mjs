...
const newLoader = 'import("/daily-day.js?v=joy-daily-day-v40").catch(() => {});';
...
console.log("Daily Day streak labels/counts corrected from 12.5px to 13.5px; cache bumped to v40");
