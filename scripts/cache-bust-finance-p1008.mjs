...
const refineStyles = '      <link rel="stylesheet" href="project-data/finance/finance-p1008-refine-v3.css?v=joy-finance-p1008-refine-v5">';
const refineScript = '      <script src="project-data/finance/finance-p1008-refine-v3.js?v=joy-finance-p1008-refine-v5" defer></script>';
...
console.log("P1008 assets cache-busted with fullscreen capture mode v5");