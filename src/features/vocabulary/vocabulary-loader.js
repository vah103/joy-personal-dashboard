(() => {
  ...
  const CHAT_RESPONSE_SCRIPT_URL = "/project-data/vocabulary/vocabulary-chat-response.js?v=joy-vocabulary-chat-v2";
  ...
  function loadChatResponse() {
    ...
    if (existing && existing.src.includes("joy-vocabulary-chat-v2")) {
