(() => {
  ...
  const LIBRARY_SCRIPT_URL = "/project-data/vocabulary/vocabulary-library.js?v=joy-vocabulary-library-v2";
  ...
  function loadLibrary() {
    ...
    if (existing && existing.src.includes("joy-vocabulary-library-v2")) {
