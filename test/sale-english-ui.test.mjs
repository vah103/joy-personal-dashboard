...
test("build keeps the Sale adapter while shared i18n is injected globally", async () => {
  const [build, i18nBuild, bootstrap, salePage, history] = await Promise.all([
  ...
  assert.match(i18nBuild, /i18n\/index\.js/);
