...
test("IELTS dashboard card loads the organized August Coach, baseline and AI reviewer", () => {
  ...
  assert.ok(build.includes("project-data/ielts/ielts-core-bundle.js?v=ielts-august-core-v6"));
  ...
  assert.ok(build.includes("project-data/ielts/ielts-card.js?v=ielts-card-v7"));
  ...
  assert.ok(script.includes("ielts-core-bundle.js?v=ielts-august-core-v6"));
