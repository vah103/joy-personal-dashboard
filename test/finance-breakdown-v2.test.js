...
test("Finance policy loads before core and expense map loads after core", () => {
  assert.match(injectSource, /finance-amount-policy-v3\.js\?v=joy-finance-amount-policy-v4/);
  assert.match(injectSource, /finance-demo\.js\?v=joy-finance-core-v7/);
  assert.match(injectSource, /finance-breakdown-v2\.js\?v=joy-finance-breakdown-v2/);
